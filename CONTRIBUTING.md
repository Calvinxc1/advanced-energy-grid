...
Advanced Energy Grid owns electric poles, substations, long-distance transmission, electric distribution/transmission technologies, recipes, items, and entities for Factorio 2.0 and Space Age grid infrastructure.

Keep changes focused on that scope. Compatibility fixes are welcome when they preserve the mod's staged electric-grid progression and do not move unrelated gameplay systems into this repository.
