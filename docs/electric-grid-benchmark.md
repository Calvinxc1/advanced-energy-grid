...
- Advanced Energy Grid registers its upgraded poles with Power Overload 2.2.0 or newer, using proportional default overload limits based on Power Overload's Tier 1 defaults.
...
| Small Electric Pole MK2 | local distribution | AEG | `9` | `3.5` | Improved electric poles | early upgraded local coverage | `20MW` |
...
| Substation MK2 | dense local distribution | AEG | `20` | `10` | Improved local energy distribution 2 | improved dense coverage | `250MW` |
| Substation MK3 | dense local distribution | AEG | `22` | `11` | Improved local energy distribution 3 | late dense coverage | `500MW` |
| Substation MK4 | dense local distribution | AEG | `24` | `12` | Improved local energy distribution 4 | Space Age dense coverage | `1GW` |
...
| Huge Electric Pole MK2 | backbone transmission | AEG + Power Overload | `48` | `0` | Improved distance power transmission 2 | upgraded huge-pole backbone | `6GW` |
| Huge Electric Pole MK3 | backbone transmission | AEG + Power Overload | `56` | `0` | Improved distance power transmission 3 | late huge-pole backbone | `12GW` |
| Huge Electric Pole MK4 | backbone transmission | AEG + Power Overload | `64` | `0` | Improved distance power transmission 4 | final huge-pole backbone | `24GW` |
